...
sunburstD3 = function module() {
  ...
  var color = d3.scale.ordinal() .range(["#8dd3c7","#bebada","#fb8072","#80b1d3","#fdb462","#b3de69","#b15928","#e5c494","#fccde5","#bc80bd","#ccebc5","#ffed6f","#1f78b4"]);
    ...
    .outerRadius(function(d) { return Math.sqrt(d.y + d.dy); });
                ...
                //.cornerRadius(function(d) { return 20}); //http://bl.ocks.org/mbostock/b7671cb38efdfa5da3af
        ...
        _selection.each(function(_data){ 
            ...
            */
            ...
            this.path = svg.datum(_data).selectAll("path")
                ...
                d3.select("#saveSunburst").on("click", exportAsImage);
         ...
         _updateBreadcrumbs(seqArray);
                ...
                d3.selectAll("path")
                    .filter(function(node){
                        return (seqArray.indexOf(node) >= 0);})
                    .style("opacity", 1);
...
function exportAsImage(){
    ...
    // get the svg chart div name 
        ...
        svg = document.querySelector( '#sunburst svg' );
